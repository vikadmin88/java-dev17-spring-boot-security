...
class JavaDev17SpringBootSecurityApplicationTests {
    ...
    void testAddNote() {
        //When
        NoteDto noteObj = noteService.add(note, "admin");
    ...
    void testGetById() throws NoteNotFoundException {
        //When
        note.setTitle("TEST");
        NoteDto noteAdded = noteService.add(note, "admin");
